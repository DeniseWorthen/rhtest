...
# -----------------------------------------------------------------------------
rhtest: rhtest.o aMesh.o med_internalstate_mod.o med_map_mod.o med_kind_mod.o
	$(ESMF_F90LINKER) $(ESMF_F90LINKOPTS) $(ESMF_F90LINKPATHS) $(ESMF_F90LINKRPATHS) -o $@ $^ $(ESMF_F90ESMFLINKLIBS)

# module dependencies:
rhtest.o: aMesh.o med_internalstate_mod.o med_map_mod.o
aMesh.o: med_kind_mod.o
med_internalstate_mod.o: med_kind_mod.o
med_map_mod.o: med_internalstate_mod.o med_kind_mod.o
med_kind_mod.o:
